export default class LoreBatalhaFinalScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.dialogos = [
            ...
            { nome: '', fala: 'Então, sem tempo para o grupo processar o que está havendo, 3 criaturas enormes e brancas aparecem.' },
            ...
            { nome: 'Archibald', fala: 'O que? COMO ASSIM NÃO? Você não vê que não podemos contra eles?' },
            ...
            { nome: 'Gerwald', fala: '*susto* Ah, não, se preocupe comigo. Escute, vou no seu quarto pegar algumas roupas para você, já que estás todo sujo.' },
            { nome: '', fala: 'Gerwald então sobe as escadas até o quarto de Siegel. Siegel percebe na mesa um diário que nunca tinha visto antes, e pega para ele.' },
            ...
            { nome: 'Diário', fala: 'EU CONSEGUI, hoje eu consegui armazenar a alma dela, o brilho da orbe é belo, assim como ela... Aguente mais um pouco... só mais um pouco...' },
            { nome: 'Diário', fala: 'NÃO FUNCIONA, não entendo por que não funciona, era para... ERA PARA ELA ESTAR AQUI... onde foi que eu errei.' },
            { nome: 'Diário', fala: 'Hoje um portal se abriu no céu, pela posição... me parece muito ser o túmulo dela... mas como isso é possível, era para ela estar de volta... porque o orbe trouxe essas coisas para cá.' },
            ...
            { nome: 'Gerwald', fala: '…' },
            { nome: 'Siegel', fala: 'VO-VOCE TEM NOÇÃO DO QUE ESTÁ FAZENDO?' },
            ...
            { nome: '', fala: 'Siegel entra em uma luta corporal com seu pai pela orbe, mas como Siegel estava exausto, com uma simples magia seu pai consegue jogá-lo para longe e então, Gerwald com a orbe sobe as escadas do porão.' },
            ...
            { nome: 'Siegel', fala: 'ELE... A ORBE QUE ELE ESTÁ NA MÃO QUE CRIOU ESSE PORTAL, PAREM ELE!!' },
            ...
            { nome: 'Gerwald', fala: 'NAAAAO!, EU VOU TRAZÊ-LA DE VOLTA E VOCÊS NÃO VÃO ME IMPEDIR!!' },
