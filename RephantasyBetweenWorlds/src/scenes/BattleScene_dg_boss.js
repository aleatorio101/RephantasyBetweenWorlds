...
export default class BattleScene_dg_boss extends Phaser.Scene {
    ...
    preload() {
        //bgm
        this.load.audio('battle_bgm', 'assets/sounds/bgm/Decisive Battle 1.mp3')
        ...
        this.load.audio('minotaur_attack_sfx', 'assets/sounds/sfx/08_Bite_04.wav');
    ...
    selectAbility(index) {
        ...
        if (selectedAbility.target === 'all_allies') {
            ...
            // Definir targetType correto para seleção de alvo:
            // Se a habilidade é para curar "single_ally", o alvo deve ser aliado ('player')
            // Caso contrário (ataque), o alvo deve ser inimigo ('enemy')
