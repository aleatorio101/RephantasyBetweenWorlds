export default class LoreLaraScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.dialogos = [
            ...
            { nome: '', fala: 'Siegel então luta com as criaturas e acaba vencendo elas, porém mais delas aparecem.' },
            ...
            { nome: '', fala: 'Vultos rapidamente se colidem com o chão, mas continuam inteiros e sem aparente machucados. Siegel vê um homem loiro com armadura semi-completa (sem elmo), um jovem com um aparato estranho nas mãos e uma adolescente de vestido azul e chapéu amarelo.' },
            ...
            { nome: 'Siegel', fala: 'Que? não conheço esse lugar, você está em Almandía. Se bem que você pode ser um cidadão do céu devido à sua apresentação…' },
            { nome: 'Homem loiro', fala: 'Bem, estou tão confuso quanto você. Eu lembro de estar no campo de batalha, quando na hora que eu ia receber um golpe, acabei imediatamente entrando em queda livre. Eu morri? Aqui é o céu? Ó não, EU ESTOU NO INFERNO??' },
            ...
            { nome: '', fala: 'Siegel então olha para além da vila e vê ao céu um portal.' },
            ...
            { nome: 'Siegel', fala: 'Vem comigo, quero ir até o meu pai para ver se ele está bem.' },
            ...
            { nome: 'Gerwald', fala: 'Criaturas? Mas o que?' },
