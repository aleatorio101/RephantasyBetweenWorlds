...
export default class BattleScene_dg extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('goblin_ataque', 'assets/enemies/goblin/goblin_atk_spritesheet-sheet.png', {
            frameWidth: 600,
            frameHeight: 600
        });
    ...
    create() {
        ...
        if (!this.textures.exists('goblin_attack')) {
            console.warn('Spritesheet goblin_attack ainda não carregada!');
        }
